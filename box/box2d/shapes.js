...
// each shape has a type member...
		bH.GT = function () {return this.GetType()}
		...
		b2d.iH = b2d.isShape = function (h) {
			...
			return ty == "b2PolygonShape" ? 'p' :
					ty == "b2CircleShape" ? 'c' :
							ty == "b2AShape" ? 'a' : false}
		bH.ty = function () {return b2d.iH(this)}
		
		b2d.iP = b2d.iPH = function () {return this.iH() == 'p'}
		b2d.iC = b2d.iCH = function () {return this.iH() == 'c'}
		b2d.iA = b2d.iAH = function () {return this.iH() == 'a'}
		
		bH.iP=function(){return b2d.iP(this)}
		bH.iC = function () {
			return b2d.iC(this)
		}
		bH.iA = function () {
